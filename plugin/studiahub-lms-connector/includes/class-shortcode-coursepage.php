...
final class Shortcode_CoursePage {
    ...
    public static function render($atts): string {
        ...
        <?php endif; ?>
        <?php
        // El output NO debe pasar por wpautop (rompe el HTML estructurado).
        // Devolvemos un placeholder y el HTML real se inyecta después de que
        // wpautop corrió — ver Render_Guard.
