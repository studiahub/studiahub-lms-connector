...
| Un combo se cobra un número raro que nadie cargó (ej. 288.100 ARS por un pack de USD 200) | Plugin anterior a 0.17.0: el safeguard solo cubría los cursos del LMS, no los combos | Actualizar el plugin a ≥ 0.17.0: ahora el checkout se frena en vez de cobrar la conversión. |
